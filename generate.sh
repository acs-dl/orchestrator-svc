...
GENERATED="${GOPATH}/src/gitlab.com/distributed_lab/acs/orchestrator/resources"
OPENAPI_DIR="${GOPATH}/src/gitlab.com/distributed_lab/acs/orchestrator/docs/web_deploy"
